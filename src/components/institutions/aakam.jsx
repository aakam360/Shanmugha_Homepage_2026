...
const Aakam = () => {
  return (
    <>
      ...
      <Box sx={{ py: { xs: 6, md: 2 }, bgcolor: "#f8f9fa" }}>
        {" "}
        {/* CHANGE: Increased vertical padding */}
        <Container maxWidth="xl">
          {" "}
          {/* CHANGE: Increased maxWidth to "xl" for a wider layout */}
          <Typography
            variant="h1"
            sx={{
              textAlign: "center",
              color: "text.primary",
              fontSize: { xs: "2.4rem", md: "3.15rem" },
            }}
          >
            {" "}
          ...
          <Typography
            ...
            sx={{
              ...
              color: "#00205B",
              mb: 3,
              fontSize: { xs: "1rem", md: "3.35rem" },
            }}
          >
            {" "}
            {/* CHANGE: Increased font size and margin */}
          ...
          >
            ...
            <Grid container spacing={{ xs: 5, md: 8 }} alignItems="center">
              {" "}
              {/* CHANGE: Increased spacing */}
              {/* --- Left Column --- */}
              <Grid size={{ xs: 12, md: 6 }}>
                <Typography variant="h5" color="#00205B" sx={{ mb: 1 }}>
                  {" "}
                  {/* CHANGE: Increased variant */}
                  About Aakam360
                </Typography>
                <Typography
                  component="h3"
                  sx={{
                    ...
                    color: "text.primary",
                    mb: 3,
                    fontSize: { xs: "2rem", md: "3.2.5rem" },
                    lineHeight: 1.2,
                  }}
                >
                  {" "}
                  {/* CHANGE: Increased font size and line height */}
                  <Box component="span" sx={{ color: "#20c997" }}>
                    Transforming
                  </Box>{" "}
                  Education & Industry
                </Typography>
                <Typography
                  ...
                  sx={{ mb: 5, lineHeight: 1.8, fontSize: "1.4.5rem" }}
                >
                  {" "}
                  {/* CHANGE: Increased font size and line height */}
                  At Aakam360, we believe in the power of bridging the gap
                  between academic excellence and industry innovation. Our
                  comprehensive 5i Framework ensures holistic development for
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                >
                  {" "}
                  {/* CHANGE: Adjusted background and padding */}
                  <Typography
                    variant="h4"
                    sx={{
                      fontWeight: "bold",
